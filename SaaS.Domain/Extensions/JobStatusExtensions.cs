...
namespace SaaS.Domain.Extensions
{
    ...
    /// DB values ("Processing"). Always go through ToDbString()/ParseFromDbToAccountStatus() instead.
    /// </summary>
    public static class JobStatusExtensions
    {
        ...
        public static JobStatus ParseFromDbToJobStatus(this string dbValue) => dbValue switch
        {
